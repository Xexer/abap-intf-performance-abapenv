...
"! <em>com.sap.gateway.srvd_a2x.zbs_demo_perfromance_data.v0001</em>
CLASS zcl_bs_demo_intf_o4 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">Value Control Structure of PERFROMANCE_TYPE</p>
      BEGIN OF tys_value_controls_1,
        "! NEW_DATE
        new_date     TYPE /iwbep/v4_value_control,
        "! UTCTIMESTAMP
        utctimestamp TYPE /iwbep/v4_value_control,
...
CLASS zcl_bs_demo_intf_o4 IMPLEMENTATION.

  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'com.sap.gateway.srvd_a2x.zbs_demo_perfromance_data.v0001' ) ##NO_TEXT.
